...
def load_data():
    try:
        customer_prof_individual = pd.read_excel('C:/Users/pathi/Hackathon/Hyper-Personalization/Data/Customer_Profile_Individual.xlsx')
        customer_prof_organization = pd.read_excel('C:/Users/pathi/Hackathon/Hyper-Personalization/Data/Customer_Profile_Organization.xlsx')
        social_media_sent = pd.read_excel('C:/Users/pathi/Hackathon/Hyper-Personalization/Data/Social_Media_Sentiment.xlsx')
        transaction_history = pd.read_excel('C:/Users/pathi/Hackathon/Hyper-Personalization/Data/Transaction_History.xlsx')
